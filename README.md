...
[NoPaste](https://nopaste303.vercel.app/) is an open-source website similar to Pastebin where you can store any piece of code, and generate links for easy sharing
...
> **Double Note:** This is a fork of [@bokub's NoPaste](https://github.com/bokub/nopaste)
...
<iframe
    ...
    height="243"
    frameborder="0"
    src="https://nopaste303.vercel.app/?l=py#"
></iframe>
```
...
### URL Shortening (Fork specific)

This fork can shorten your NoPaste links using [v.gd](https://v.gd).

This is useful if you want to share your code on social media, but the link is too long.
But this also has maximum link length limit, which are listed [below](#maximum-sizes-for-links).
...
> **Note:** URL Shortening does not work offline
...
```bash
# Linux
echo -n 'Hello World' | lzma | base64 -w0 | xargs -0 printf "https://nopaste303.vercel.app/#%s\n"

# Mac
echo -n 'Hello World' | lzma | base64 | xargs -0 printf "https://nopaste303.vercel.app/#%s\n"

# Windows / WSL / Linux
echo -n 'Hello World' | xz --format=lzma | base64 -w0 | printf "https://nopaste303.vercel.app/#%s\n" "$(cat -)"
```

## Generate v.gd links (Fork specific)

```bash
# url_from_above is the NoPaste link generated from the above section
curl 'https://v.gd/create.php?format=simple' --data-urlencode "url=${url_from_above}"
```
